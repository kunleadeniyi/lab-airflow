...
from f1.tasks import (
    ...
    _get_meetings, _get_most_recent_meeting, _get_pits, _get_positions,
    _get_race_control, _get_sessions, _get_stints, _get_team_radio,
    _store_meetings, _store_sessions, _get_session_list, _get_driver_list, _get_laps,
)
...
def f1():
    ...
    # Wire up the DAG — XCom dependencies are implicit via function call arguments
